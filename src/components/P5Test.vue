<template>
  <!-- <div style="border:2px solid #F00; width:100%; height:100px;" id="app">
    <div id="canvas" class="p5Canvas"></div>
  </div> -->
...
export default {
  ...
  methods: {
    ...
    // setup() {
    //   console.log("befor createCanvas");
    ...
    //   console.log("after createCanvas")
    //   // 360/640/0/180
    //   colorMode(HSB, 360);
    ...
    draw() {
      ...
      if (allParticles.length > 0) {
        ...
        dataMouse = Delaunay.triangulate(allParticles.map(function(pt) {
        ...
        for (var i = 0; i < dataMouse.length; i += 3) {
          // Collect particles that make this triangle.
          var p1 = allParticles[dataMouse[i]];
          var p2 = allParticles[dataMouse[i+1]];
          var p3 = allParticles[dataMouse[i+2]];
